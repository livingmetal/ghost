...
|---|---|---|---|
| `forward_clasped` | idle, listening, speaking, soft-smile, happy | 기본 대기/일반 응답 | 메이드 모드의 정면 손 모음 자세를 기반으로 한 첫 번째 fitting 기준 |
| `neutral_stand` | alternate idle | 팔을 내린 직립 대체 포즈 | 기본 포즈가 실루엣을 가릴 때만 사용 |
...
| hair_back | body보다 뒤에 두고 머리와 함께 작은 sway만 적용 |
| hair_side_left/right | 어깨 바깥쪽 긴 웨이브. 독립적으로 아주 작은 sway 허용 |
...
1. `forward_clasped`에서 breathing, blink, subtle head motion이 가능하다.
